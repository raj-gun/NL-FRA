function [Norm_SSE_abs_LS_2,Norm_SSE_arg_LS_2,Norm_SSE_LS_2,Fe_n_Yn,Fe_p_Yn,Y_NOFRF_MLS_n,Y_NOFRF_LS_2,Y_model] = NOFRF_Y_pred_comp(pos_freq_comp, u, y, Ts, Fs, N, nl_ord_set, Amp, len_adj, len_adj_hlf, G_LS_2, rmv_U_mat, freq_rng_all, c, harm_inpt, lw, norm, draw_plt)
...
Error_abs_LS_2 = abs(Y_vec(freq_rng_all)) - abs(Y_NOFRF_LS_2(freq_rng_all));
...
Norm_SSE_abs_LS_2 = sum(Error_abs_LS_2.^2,1)/var(abs(Y_vec(freq_rng_all)));
Norm_SSE_arg_LS_2 = sum(Error_arg_LS_2.^2,1)/var(angle(Y_vec(freq_rng_all)));
