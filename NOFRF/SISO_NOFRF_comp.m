function [Norm_SSE_abs_LS_2,Norm_SSE_arg_LS_2,Norm_SSE_LS_2,Fe_n_Yn,Fe_p_Yn,Y_NOFRF_MLS_n,Y_NOFRF_LS_2,G_LS_2,sse,Y_model] = ...
    SISO_NOFRF_comp(Fs,Ts,tspan,fftn,pos_freq_comp,u_nofrf,A,Amp,nl_ord_set,gc,harm_inpt,lw,norm,displ,Y,y_test)
...
N = max(nl_ord_set);
[G_LS_2,~,~,~,rmv_U_mat,~,len_adj_hlf,sse] = ...
    NOFRF_LS2comp(u_nofrf,Y,A,N,Fs,Ts,pos_freq_comp,nl_ord_set,fftn,displ(1));
